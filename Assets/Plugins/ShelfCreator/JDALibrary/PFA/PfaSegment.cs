...
namespace JDA
{
    public partial class PFA
    {
        public class Segment
        {
            ...
            public Dictionary<string, string> Fields;           // Data for each field read from the segment line of the PFA file        
            ...
            private static string[] _fieldNames = new string[]
        {
            ...
            public float Angle {
                ...
                set { Fields[FieldNames.Angle] = value.ToString("F0"); }
            }
            ...
            public float OffsetX {
                get { return float.Parse(Fields[FieldNames.OffsetX]); }
                set { Fields[FieldNames.OffsetX] = value.ToString("F2"); }
            }

            public static Segment ParsePFA(string line) {
            ...
            /// <summary>
            /// Generates the PFA output string representation for a segment.
            /// </summary>
