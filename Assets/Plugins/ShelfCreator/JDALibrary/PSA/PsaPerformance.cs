...
namespace JDA
{
    ...
    {
        /// <summary>
        /// Performance data contains fields of information about product sales and logistics.  Performance data is optional.
        /// </summary>
        public class Performance
        {
            ...
            public class FieldNames
            {
                ...
                public const string AssortmentRank = "Assortment rank";
                public const string RecommendedFacings = "Recommended facings";
                public const string AssortmentStrategy = "Assortment strategy";
                public const string AssortmentTactic = "Assortment tactic";
                public const string AssortmentReason = "Assortment reason";
                public const string AssortmentAction = "Assortment action";
                public const string PartID = "PartID";
                public const string ClusterName = "Cluster name";
                public const string TargetDistributionStores = "Target distribution stores";
                public const string TargetDistributionPct = "Target distribution%";
                public const string AssortmentNote = "Assortment note";
                ...
                public const string RecommendedOrientation = "Recommended orientation";
                public const string RecommendedMerchStyle = "Recommended merch style";
                public const string IgnoreRecommendations = "Ignore recommendations";
                public const string Priority = "Priority";
                public const string PriorityDesc = "Priority Desc";
                public const string ForceList = "Force List";
                public const string PGReasons = "PG Reasons";
            ...
            public Dictionary<string, string> Fields;           // Data for each field read from the performance line of the PSA file        
            ...
            private static string[] _fieldNames = new string[]
        {
            ...
            /// <summary>
            /// The Performance object and its associated Product object use the same dictionary key format.
            /// </summary>
            public static string CreateDictionaryKey(string ID, string UPC)
            {
                return Product.CreateDictionaryKey(ID, UPC); 
            }



            /// <summary>
            /// The key for this performance record in the planograms's Product dictionary.
            /// </summary>
            public string DictionaryKey
            {
                get { return Performance.CreateDictionaryKey(this.ID, this.UPC);  }
            }
            ...
            public double UnitMovement {
                get { return double.Parse(Fields[FieldNames.UnitMovement]); }
                set { Fields[FieldNames.UnitMovement] = value.ToString(); }
            }

            public static Performance ParsePSA(string line) {
            ...
            public decimal Price {
                get { return decimal.Parse(Fields[FieldNames.Price]); }
                set { Fields[FieldNames.Price] = value.ToString(); }
            }

            public override string ToString() {
                return "PSA Performance " + UPC;
            }
            ...
            /// <summary>
            /// Generates the PSA output string representation for a performance object.
            /// </summary>
