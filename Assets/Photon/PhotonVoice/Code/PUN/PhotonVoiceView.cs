...
namespace Photon.Voice.PUN
{
    ...
    public class PhotonVoiceView : VoiceComponent
    {
        ...
        private void Start()
        {
            ...
            //grab speaker so it's unique to the player - FigJ
            speakerInUse = GetComponent<Speaker>();
            recorderInUse = GameObject.Find("PhotonRecorder").GetComponent<Recorder>();
            recorderInUse.Init(GetComponent<VoiceConnection>());
        }
